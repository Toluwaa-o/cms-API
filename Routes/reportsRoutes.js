...
const { getAllReports, deleteReport, updateReport, getReport, getStats, createReport, uploadFile, updateReponse } = require('../Controllers/reportsController')
...
router.route('/:id/response').patch(updateReponse)
